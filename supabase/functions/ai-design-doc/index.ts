...
const DESIGN_DOC_SYSTEM_PROMPT = `You are Clay's design-system generator. Given the user's business idea, their questionnaire answers, and their chosen visual identity, you produce TWO things in one JSON response:
...
Project slug (used in the deployment URL): "${ctx.slug}"
